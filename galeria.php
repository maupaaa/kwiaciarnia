...
?>
    ...
    <section>
    <h1 class="hgaleria">Pokaż swój bukiet!</h1>
        <p class="textgaleria">Korzystałeś/aś z naszych usług? Zostaw nam opinie!</p>
        <form action="" method="post" ENCTYPE="multipart/form-data">
        <input type="file" name="plik" id="plik" class="guzikgaleria"><br>
        <input type="text" name="tresc" id="tresc" placeholder="Treść twojej opinii." class="guzikgaleria"><br>
        <input type="submit" value="Prześlij" name="submit" class="guzikgaleria">
        </form>
        <?php
    if(!isset($_SESSION['login'])) {
        echo "<p class='textgaleria'> Aby dodać opinię musisz się zalogować.</p>";
    }
        ?>
